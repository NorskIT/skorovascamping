...
- Imported or time-sensitive content must remain `status: published` until a human has fact-checked it on beta. Production builds must fail rather than publish review content.
