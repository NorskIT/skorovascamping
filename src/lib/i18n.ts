...
export const messages = {
	nb: {
		...
		legalInformation: 'Juridisk informasjon',
		book: 'Bestill plass',
		readMore: 'Les mer',
		...
		businessDetails: 'Firmaopplysninger',
		operatorName: 'Driftsansvarlig',
		...
		previousPicture: 'Forrige bilde',
		nextPicture: 'Neste bilde',
		galleryThumbnails: 'Alle bilder',
	...
	en: {
		...
		galleryThumbnails: 'All pictures',
